  ...
  return (
    <footer className="site-footer">
      <div className="footer-main container">
        ...
        <div><span className="footer-label">Hubungi</span><a href="mailto:hello@livcoindonesia.com">hello@livcoindonesia.com</a><a href="tel:+622100000000">+62 21 0000 0000</a><p>Jakarta, Indonesia</p></div>
      </div>
